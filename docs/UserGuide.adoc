...
[#register]
.UI changes for register command
image::RegisterUGDiagram.png[width="600"]
...
`list` +
`undo` +
Undoes the `delete 1` command. (see <<#undo>> below for UI changes). +

[#undo]
.UI changes for undo command
image::RegisterUGDiagram.png[width="600"]
