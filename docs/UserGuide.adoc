...
=== Listing all persons registered in an event: `list-registered`
...
// tag::undoredo[]
=== Undoing previous command : `undo` `[Undergoing revamp, currently unavailable]`
...
=== Redoing the previously undone command : `redo` `[Undergoing revamp, currently unavailable]`
