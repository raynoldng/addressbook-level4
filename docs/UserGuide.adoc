...
=== Setting up a lucky draw for event participants `[coming in v2.0]`

=== Setting hotkeys for commands `[coming in v2.0]`

=== Entering commands in natural language `[coming in v2.0]`
