...
=== Keep all participants' and events' data in persistent storage `[coming in v1.5]`

=== Import participant contact information from an csv file `[coming in v1.5]`

=== Export participant contact information to an csv file `[coming in v1.5]`

=== Include privacy settings for participants' information `[coming in v2.0]`

=== Find a participant by his/her initials `[coming in v2.0]`

=== Add feedback for event from participant `[coming in v2.0]`

=== Export event details (attendance rate, feedback etc) in a presentable format `[coming in v2.0]`
