...
* It binds itself to some data in the Model component so that the UI can auto-update when data in the Model component changes.
* It responds to events raised from various parts of the App and updates the UI accordingly.
