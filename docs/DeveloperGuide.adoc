...
// 3 different cards include class diagram (TODO: make card abstract?)

// Attendance card is has a bind property


// Binding data to attendance list and observableepicevent (observer pattern)
