...
** Pros: Easier for new Computer Science undergraduates to understand, who are likely to be new incoming developers of our project.
...
The implementation uses a class called `Attendance`. An instance of `Attendance` is created every time a person registers to an event and
