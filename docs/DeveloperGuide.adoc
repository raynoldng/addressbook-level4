...
The modular architecture also provides you with the flexibility to change and configure existing UI elements without manipulating a large complex single-component repository.

====  Functional Overview

The UI consists of a `MainWindow` that contains the X main layout regions:
