...
[NOTE]
Note how the `Model` simply raises a `EventPlannerChangedEvent` when the Address Book data is changed, instead of asking the `Storage` to save the updates to the hard disk.
