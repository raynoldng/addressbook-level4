...
import seedu.address.storage.EventPlannerStorage;
import seedu.address.storage.JsonUserPrefsStorage;
import seedu.address.storage.Storage;
import seedu.address.storage.StorageManager;
import seedu.address.storage.UserPrefsStorage;
import seedu.address.storage.XmlEventPlannerStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing EventPlanner ]===========================");
        super.init();
        ...
        EventPlannerStorage eventPlannerStorage = new XmlEventPlannerStorage(userPrefs.getAddressBookFilePath());
        storage = new StorageManager(eventPlannerStorage, userPrefsStorage);
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty EventPlanner");
            initialData = new EventPlanner();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting EventPlanner " + MainApp.VERSION);
