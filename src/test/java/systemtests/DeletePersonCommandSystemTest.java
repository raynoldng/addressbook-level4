...
public class DeletePersonCommandSystemTest extends EventPlannerSystemTest {
    ...
    public void delete() {
        ...
        */
        ...
        command = DeletePersonCommand.COMMAND_WORD + " " + selectedIndex.getOneBased();
        ...
        command = DeletePersonCommand.COMMAND_WORD + " -1";
        assertCommandFailure(command, MESSAGE_INVALID_DELETE_COMMAND_FORMAT);

        /* Case: invalid index (size + 1) -> rejected */
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getEventPlanner().getPersonList().size() + 1);
        command = DeletePersonCommand.COMMAND_WORD + " " + outOfBoundsIndex.getOneBased();
        assertCommandFailure(command, MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
     ...
     * {@code EventPlannerSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
