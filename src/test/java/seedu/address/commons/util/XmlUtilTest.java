...
public class XmlUtilTest {
    ...
    private static final int VALID_NUMBEROFEVENTS = 0;
    ...
    public void getDataFromFile_nullFile_throwsNullPointerException() throws Exception {
        ...
        XmlUtil.getDataFromFile(null, EventPlanner.class);
    }
    ...
    public void getDataFromFile_missingFile_fileNotFoundException() throws Exception {
        ...
        XmlUtil.getDataFromFile(MISSING_FILE, EventPlanner.class);
    }

    @Test
    public void getDataFromFile_emptyFile_dataFormatMismatchException() throws Exception {
        thrown.expect(JAXBException.class);
        XmlUtil.getDataFromFile(EMPTY_FILE, EventPlanner.class);
    }
    ...
    public void xmlAdaptedPersonFromFile_fileWithMissingPersonField_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                null, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_NUMBEROFEVENTS, VALID_TAGS);
    ...
    public void xmlAdaptedPersonFromFile_fileWithInvalidPersonField_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                VALID_NAME, INVALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_NUMBEROFEVENTS, VALID_TAGS);
        assertEquals(expectedPerson, actualPerson);
    }
    ...
    public void xmlAdaptedPersonFromFile_fileWithValidPerson_validResult() throws Exception {
        ...
        XmlAdaptedPerson expectedPerson = new XmlAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_NUMBEROFEVENTS, VALID_TAGS);
        assertEquals(expectedPerson, actualPerson);
    }
    ...
    public void saveDataToFile_nullFile_throwsNullPointerException() throws Exception {
        thrown.expect(NullPointerException.class);
        XmlUtil.saveDataToFile(null, new EventPlanner());
    }
    ...
    public void saveDataToFile_missingFile_fileNotFoundException() throws Exception {
        thrown.expect(FileNotFoundException.class);
        XmlUtil.saveDataToFile(MISSING_FILE, new EventPlanner());
    }
