...
public class TypicalPersons {
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_PERSON_NAME_AMY).withPhone(VALID_PERSON_PHONE_AMY)
            .withEmail(VALID_PERSON_EMAIL_AMY).withAddress(VALID_PERSON_ADDRESS_AMY).withTags(VALID_PERSON_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_PERSON_NAME_BOB).withPhone(VALID_PERSON_PHONE_BOB)
            .withEmail(VALID_PERSON_EMAIL_BOB).withAddress(VALID_PERSON_ADDRESS_BOB).withTags(VALID_PERSON_TAG_HUSBAND, VALID_PERSON_TAG_FRIEND)
            .build();
